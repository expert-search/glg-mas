...
# Load the LDA Model
def load_model(version_number = 0.1, path = MODEL_PATH):
...
def load_id2word_embedding(version_number = 0.1, embedding_path = EMBEDDING_PATH):
...
def load_topics_dict(version_number = 0.1):
	if float(version_number) == 0.1:
